...
Officer: 5121330
CaseNum: 501-3-30752834-5121330
...
function draw() {
    ...
    for(var i = 0; i < 8; i++){
        for(var j =0; j < 4; j++){
            if(j == 0 ){
//               image(chessPieceImg, 543 + i * 70, 394 +j * 70);
                 image(chessPieceImg, 612 + i * 70, 323 + j * 50);
            } else if(j == 2){
//                image(chessPieceImg, 612 + i * 70, 323 + j * 50);
                image(chessPieceImg, 543 + i * 70, 394 );
            } else if(j == 3){
                image(chessPieceImg, 614 + i * 70, 467 );
            } else {
                image(chessPieceImg, 541 + i * 70, 543 );
            }
